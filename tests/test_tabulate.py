...
TEST_SERVICE = "arcgis_geoprocessing_tools_test_data"
...
#         "layers":[
#             {"layerID":0},
#             {"layerID":1,"attributes":[
#                 {"attribute":"NAME"},
#                 {"attribute":"AGE_18_21", "statistics":["MIN","MAX"]},
#                 {"attribute":"POP2000","classes":[[0,1000],[1000,10000],[10000,1000000]]}
#             ]},
#             {"layerID":2,"attributes":[{"attribute":"CLASS"}]},
#             {"layerID":3, "attributes":[{"attribute":"NAME"}]},
#             {"layerID":4},
#             {"layerID":5,"classes":[[0,300],[300,310],[310,400]]},
#             {"layerID":5,"statistics":["MIN","MAX","MEAN","STD","SUM"]}
#             {"layerID":6,"attributes":[{"attribute":"GEZ_TERM"}]},
#             {"layerID":7,"classes":[[0,50],[50,100],[100,150],[150,200]]},
#             {"layerID":7,"statistics":["MIN","MAX","MEAN","STD","SUM"]}
#         ]
#     }
# ]}
# """.format(TEST_SERVICE)
...
def test_poly_aoi(messages):
    ...
    messages.addMessage("PASSED: basic feature analysis")


    messages.addMessage("TESTING: basic raster analysis")
    config_json = """
    {"services":[
        {
            "serviceID":"%s",
    ...
    messages.addMessage("PASSED: basic raster analysis")



    messages.addMessage("PASSED: feature analysis - different projection")
    # in South America
    poly_aoi = """{"displayFieldName":"","geometryType":"esriGeometryPolygon","spatialReference":{"wkid":102100,"latestWkid":3857},"fields":[{"name":"OBJECTID","type":"esriFieldTypeOID","alias":"OBJECTID"},{"name":"Shape_Length","type":"esriFieldTypeDouble","alias":"Shape_Length"},{"name":"Shape_Area","type":"esriFieldTypeDouble","alias":"Shape_Area"}],"features":[{"attributes":{"OBJECTID":1,"Shape_Length":215246.30346339761,"Shape_Area":1489688992.6291437},"geometry":{"rings":[[[-9735208.3022000007,1746713.7391000018],[-9721875.4946999997,1744214.0918000005],[-9698428.3741999995,1740249.945700001],[-9690119.5023999996,1750277.5940999985],[-9670426.4793999996,1751466.4142999984],[-9656584.1029000003,1741917.1530999988],[-9656015.2338999994,1725425.9221000001],[-9677159.9499999993,1733075.4968000017],[-9703988.4594000001,1721449.3372999988],[-9716296.5018000007,1728082.0058000013],[-9731974.6559999995,1719027.7270999998],[-9731974.6559999995,1731256.7595000006],[-9735208.3022000007,1746713.7391000018]]]}}]}"""
    srcFC = FeatureClassWrapper(createFeatureClass(poly_aoi))
    ...
    {"services":[
        {
            "serviceID":"%s",
            "layers":[{"layerID":6,"attributes":[{"attribute":"GEZ_TERM"}]}]
        }
    ]}
    """ % TEST_SERVICE
    ...
    messages.addMessage("TESTING: raster analysis - different projection")

    config_json = """
    {"services":[
        {
            "serviceID":"%s",
            "layers":[{"layerID":7,"statistics":["MIN","MAX","MEAN","STD","SUM"]}]
        }
    ]}
    """ % TEST_SERVICE
    results = tabulateMapServices(srcFC, json.loads(config_json), messages)
    ...
    messages.addMessage("PASSED: raster analysis - different projection")
